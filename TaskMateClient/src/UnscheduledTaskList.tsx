...
import { WEEKLY_BOARD_MAX_HEIGHT_VH } from "./utils/constants";
...
export default function UnscheduledTaskList() {
  ...
  return (
    <div
      className="relative z-40 border-2 border-slate-100 text-slate-100 rounded-lg p-2 overflow-scroll hide-scrollbar"
    ...
    >
      ...
      <div className="absolute bottom-0 right-0 flex justify-end">
        <CreateTaskButton refreshOnCreation={getUnscheduledTasks} />
      </div>
    </div>
  );
}
